...
import 'package:task_manager_application/widgets/Todo/custom_tf.dart';
import 'package:task_manager_application/widgets/Todo/custom_df.dart';
                  ...
                  child: ElevatedButton(
                    style: ButtonStyle(
                      ...
                      shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                        RoundedRectangleBorder(
                          side: const BorderSide(color: Color.fromARGB(255, 42, 107, 133), width: 3),
                          borderRadius: BorderRadius.circular(13.0),
                        ),
                      ),
                    ),
                    ...
                    child: const Text(
                      'Cancel',
                      style: TextStyle(
                          color: Color.fromARGB(255, 42, 107, 133), fontWeight: FontWeight.bold),
                    ),
                  ),
                ),
                const SizedBox(
